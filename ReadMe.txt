...
In _Layout.cshtml, changed Shipppments to Shipments
...
On Create.cshtml and Edit.cshtml for views on shipment, change CustomerID to Customer Name label.
...
In EstShipDateValidate.cs,  if (result > 0) should be changed to  (result < 0)
